...
public class StudyPhraseProgress
{
    private StudyPhraseProgress() { }

    public int Id { get; private set; }

    public int StudyPhraseId { get; private set; }
    public StudyPhrase StudyPhrase { get; private set; }
    ...
    public static StudyPhraseProgress Create(int studyPhraseId)
    {
        return new StudyPhraseProgress
        {
            StudyPhraseId = studyPhraseId,
